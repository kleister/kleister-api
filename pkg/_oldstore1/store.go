...
import (
	...
	fversion "github.com/kleister/go-forge/version"
	mversion "github.com/kleister/go-minecraft/version"
)
...
type Store interface {
	...
	SyncMinecraft(*mversion.Version, *model.User) (*model.Minecraft, error)
	...
	SyncForge(*fversion.Version, *model.User) (*model.Forge, error)
