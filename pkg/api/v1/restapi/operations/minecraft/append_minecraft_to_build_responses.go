...
// NewAppendMinecraftToBuildNotFound creates AppendMinecraftToBuildNotFound with default headers values
func NewAppendMinecraftToBuildNotFound() *AppendMinecraftToBuildNotFound {

	return &AppendMinecraftToBuildNotFound{}
}

// WithPayload adds the payload to the append minecraft to build not found response
func (o *AppendMinecraftToBuildNotFound) WithPayload(payload *models.GeneralError) *AppendMinecraftToBuildNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the append minecraft to build not found response
func (o *AppendMinecraftToBuildNotFound) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *AppendMinecraftToBuildNotFound) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
