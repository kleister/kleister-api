...
// PermitModUserNotFoundCode is the HTTP code returned for type PermitModUserNotFound
const PermitModUserNotFoundCode int = 404

/*
PermitModUserNotFound Mod or user not found

swagger:response permitModUserNotFound
*/
...
// NewPermitModUserNotFound creates PermitModUserNotFound with default headers values
func NewPermitModUserNotFound() *PermitModUserNotFound {

	return &PermitModUserNotFound{}
}

// WithPayload adds the payload to the permit mod user not found response
func (o *PermitModUserNotFound) WithPayload(payload *models.GeneralError) *PermitModUserNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the permit mod user not found response
func (o *PermitModUserNotFound) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *PermitModUserNotFound) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
...
/*
PermitModUserPreconditionFailed User is not assigned
...
/*
PermitModUserUnprocessableEntity Failed to validate request
...
func (o *PermitModUserUnprocessableEntity) WithPayload(payload *models.ValidationError) *PermitModUserUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the permit mod user unprocessable entity response
func (o *PermitModUserUnprocessableEntity) SetPayload(payload *models.ValidationError) {
	o.Payload = payload
}
