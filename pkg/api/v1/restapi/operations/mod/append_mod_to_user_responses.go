...
/*AppendModToUserPreconditionFailed Failed to parse request body
...
/*AppendModToUserUnprocessableEntity User is already assigned
...
func (o *AppendModToUserUnprocessableEntity) WithPayload(payload *models.GeneralError) *AppendModToUserUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the append mod to user unprocessable entity response
func (o *AppendModToUserUnprocessableEntity) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}
