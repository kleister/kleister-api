...
// UpdateModPreconditionFailedCode is the HTTP code returned for type UpdateModPreconditionFailed
const UpdateModPreconditionFailedCode int = 412

/*UpdateModPreconditionFailed Failed to parse request body

swagger:response updateModPreconditionFailed
*/
...
// NewUpdateModPreconditionFailed creates UpdateModPreconditionFailed with default headers values
func NewUpdateModPreconditionFailed() *UpdateModPreconditionFailed {

	return &UpdateModPreconditionFailed{}
}

// WithPayload adds the payload to the update mod precondition failed response
func (o *UpdateModPreconditionFailed) WithPayload(payload *models.GeneralError) *UpdateModPreconditionFailed {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the update mod precondition failed response
func (o *UpdateModPreconditionFailed) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *UpdateModPreconditionFailed) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
