...
/*DeleteModFromTeamPreconditionFailed Failed to parse request body
...
// DeleteModFromTeamUnprocessableEntityCode is the HTTP code returned for type DeleteModFromTeamUnprocessableEntity
const DeleteModFromTeamUnprocessableEntityCode int = 422

/*DeleteModFromTeamUnprocessableEntity Team is not assigned

swagger:response deleteModFromTeamUnprocessableEntity
*/
...
// NewDeleteModFromTeamUnprocessableEntity creates DeleteModFromTeamUnprocessableEntity with default headers values
...
// WithPayload adds the payload to the delete mod from team unprocessable entity response
func (o *DeleteModFromTeamUnprocessableEntity) WithPayload(payload *models.GeneralError) *DeleteModFromTeamUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete mod from team unprocessable entity response
func (o *DeleteModFromTeamUnprocessableEntity) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *DeleteModFromTeamUnprocessableEntity) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
