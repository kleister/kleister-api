...
type AppendModToTeamHandlerFunc func(AppendModToTeamParams, *models.User) middleware.Responder

// Handle executing the request and returning a response
func (fn AppendModToTeamHandlerFunc) Handle(params AppendModToTeamParams, principal *models.User) middleware.Responder {
...
type AppendModToTeamHandler interface {
	Handle(AppendModToTeamParams, *models.User) middleware.Responder
}
