...
type PermitTeamModHandlerFunc func(PermitTeamModParams, *models.User) middleware.Responder

// Handle executing the request and returning a response
func (fn PermitTeamModHandlerFunc) Handle(params PermitTeamModParams, principal *models.User) middleware.Responder {
	return fn(params, principal)
}

// PermitTeamModHandler interface for that can handle valid permit team mod params
type PermitTeamModHandler interface {
	Handle(PermitTeamModParams, *models.User) middleware.Responder
}
...
/*
	PermitTeamMod swagger:route PUT /teams/{team_id}/mods team permitTeamMod
