...
/*DeleteTeamFromUserPreconditionFailed Failed to parse request body
...
// DeleteTeamFromUserUnprocessableEntityCode is the HTTP code returned for type DeleteTeamFromUserUnprocessableEntity
const DeleteTeamFromUserUnprocessableEntityCode int = 422

/*DeleteTeamFromUserUnprocessableEntity User is not assigned

swagger:response deleteTeamFromUserUnprocessableEntity
*/
...
// NewDeleteTeamFromUserUnprocessableEntity creates DeleteTeamFromUserUnprocessableEntity with default headers values
...
// WithPayload adds the payload to the delete team from user unprocessable entity response
func (o *DeleteTeamFromUserUnprocessableEntity) WithPayload(payload *models.GeneralError) *DeleteTeamFromUserUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete team from user unprocessable entity response
func (o *DeleteTeamFromUserUnprocessableEntity) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *DeleteTeamFromUserUnprocessableEntity) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
