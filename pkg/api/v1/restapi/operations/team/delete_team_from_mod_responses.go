...
// NewDeleteTeamFromModNotFound creates DeleteTeamFromModNotFound with default headers values
func NewDeleteTeamFromModNotFound() *DeleteTeamFromModNotFound {

	return &DeleteTeamFromModNotFound{}
}

// WithPayload adds the payload to the delete team from mod not found response
func (o *DeleteTeamFromModNotFound) WithPayload(payload *models.GeneralError) *DeleteTeamFromModNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete team from mod not found response
func (o *DeleteTeamFromModNotFound) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *DeleteTeamFromModNotFound) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
