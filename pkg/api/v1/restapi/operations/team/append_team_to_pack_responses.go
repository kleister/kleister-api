...
// AppendTeamToPackNotFoundCode is the HTTP code returned for type AppendTeamToPackNotFound
const AppendTeamToPackNotFoundCode int = 404

/*AppendTeamToPackNotFound Team or pack not found

swagger:response appendTeamToPackNotFound
*/
type AppendTeamToPackNotFound struct {
...
// NewAppendTeamToPackNotFound creates AppendTeamToPackNotFound with default headers values
func NewAppendTeamToPackNotFound() *AppendTeamToPackNotFound {

	return &AppendTeamToPackNotFound{}
}

// WithPayload adds the payload to the append team to pack not found response
func (o *AppendTeamToPackNotFound) WithPayload(payload *models.GeneralError) *AppendTeamToPackNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the append team to pack not found response
func (o *AppendTeamToPackNotFound) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *AppendTeamToPackNotFound) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
...
/*AppendTeamToPackPreconditionFailed Pack is already assigned
...
/*AppendTeamToPackUnprocessableEntity Failed to validate request
...
func (o *AppendTeamToPackUnprocessableEntity) WithPayload(payload *models.ValidationError) *AppendTeamToPackUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the append team to pack unprocessable entity response
func (o *AppendTeamToPackUnprocessableEntity) SetPayload(payload *models.ValidationError) {
	o.Payload = payload
}
