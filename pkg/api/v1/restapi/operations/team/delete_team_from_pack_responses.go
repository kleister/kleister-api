...
// DeleteTeamFromPackNotFoundCode is the HTTP code returned for type DeleteTeamFromPackNotFound
const DeleteTeamFromPackNotFoundCode int = 404

/*DeleteTeamFromPackNotFound Team or pack not found

swagger:response deleteTeamFromPackNotFound
*/
...
// NewDeleteTeamFromPackNotFound creates DeleteTeamFromPackNotFound with default headers values
func NewDeleteTeamFromPackNotFound() *DeleteTeamFromPackNotFound {

	return &DeleteTeamFromPackNotFound{}
}

// WithPayload adds the payload to the delete team from pack not found response
func (o *DeleteTeamFromPackNotFound) WithPayload(payload *models.GeneralError) *DeleteTeamFromPackNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete team from pack not found response
func (o *DeleteTeamFromPackNotFound) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *DeleteTeamFromPackNotFound) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
...
/*DeleteTeamFromPackPreconditionFailed Pack is not assigned
