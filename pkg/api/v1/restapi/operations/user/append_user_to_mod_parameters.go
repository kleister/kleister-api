...
// AppendUserToModParams contains all the bound params for the append user to mod operation
// typically these are obtained from a http.Request
//
// swagger:parameters AppendUserToMod
...
//
// To ensure default values, the struct must have been initialized with NewAppendUserToModParams() beforehand.
func (o *AppendUserToModParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AppendUserToModParams) bindUserID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
