...
/*DeleteForgeFromBuildPreconditionFailed Failed to parse request body
...
// DeleteForgeFromBuildUnprocessableEntityCode is the HTTP code returned for type DeleteForgeFromBuildUnprocessableEntity
const DeleteForgeFromBuildUnprocessableEntityCode int = 422

/*DeleteForgeFromBuildUnprocessableEntity Build is not assigned

swagger:response deleteForgeFromBuildUnprocessableEntity
*/
...
// NewDeleteForgeFromBuildUnprocessableEntity creates DeleteForgeFromBuildUnprocessableEntity with default headers values
...
// WithPayload adds the payload to the delete forge from build unprocessable entity response
func (o *DeleteForgeFromBuildUnprocessableEntity) WithPayload(payload *models.ValidationError) *DeleteForgeFromBuildUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete forge from build unprocessable entity response
func (o *DeleteForgeFromBuildUnprocessableEntity) SetPayload(payload *models.ValidationError) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *DeleteForgeFromBuildUnprocessableEntity) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
