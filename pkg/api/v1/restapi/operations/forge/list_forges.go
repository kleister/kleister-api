...
type ListForgesHandlerFunc func(ListForgesParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ListForgesHandlerFunc) Handle(params ListForgesParams) middleware.Responder {
	return fn(params)
}

// ListForgesHandler interface for that can handle valid list forges params
type ListForgesHandler interface {
	Handle(ListForgesParams) middleware.Responder
}
