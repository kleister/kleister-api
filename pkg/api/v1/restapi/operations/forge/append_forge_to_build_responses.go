...
// NewAppendForgeToBuildNotFound creates AppendForgeToBuildNotFound with default headers values
func NewAppendForgeToBuildNotFound() *AppendForgeToBuildNotFound {

	return &AppendForgeToBuildNotFound{}
}

// WithPayload adds the payload to the append forge to build not found response
func (o *AppendForgeToBuildNotFound) WithPayload(payload *models.GeneralError) *AppendForgeToBuildNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the append forge to build not found response
func (o *AppendForgeToBuildNotFound) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *AppendForgeToBuildNotFound) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
