...
/*AppendPackToTeamPreconditionFailed Failed to parse request body
...
/*AppendPackToTeamUnprocessableEntity Team is already assigned
...
func (o *AppendPackToTeamUnprocessableEntity) WithPayload(payload *models.GeneralError) *AppendPackToTeamUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the append pack to team unprocessable entity response
func (o *AppendPackToTeamUnprocessableEntity) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}
