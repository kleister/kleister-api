...
// AppendPackToUserParams contains all the bound params for the append pack to user operation
// typically these are obtained from a http.Request
//
// swagger:parameters AppendPackToUser
...
//
// To ensure default values, the struct must have been initialized with NewAppendPackToUserParams() beforehand.
func (o *AppendPackToUserParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AppendPackToUserParams) bindPackID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
