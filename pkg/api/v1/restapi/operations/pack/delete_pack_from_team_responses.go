...
// NewDeletePackFromTeamNotFound creates DeletePackFromTeamNotFound with default headers values
func NewDeletePackFromTeamNotFound() *DeletePackFromTeamNotFound {

	return &DeletePackFromTeamNotFound{}
}

// WithPayload adds the payload to the delete pack from team not found response
func (o *DeletePackFromTeamNotFound) WithPayload(payload *models.GeneralError) *DeletePackFromTeamNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete pack from team not found response
func (o *DeletePackFromTeamNotFound) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *DeletePackFromTeamNotFound) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
