...
/*PermitPackTeamPreconditionFailed Failed to parse request body
...
/*PermitPackTeamUnprocessableEntity Team is not assigned
...
func (o *PermitPackTeamUnprocessableEntity) WithPayload(payload *models.GeneralError) *PermitPackTeamUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the permit pack team unprocessable entity response
func (o *PermitPackTeamUnprocessableEntity) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}
