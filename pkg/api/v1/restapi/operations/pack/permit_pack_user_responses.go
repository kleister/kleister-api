...
// PermitPackUserNotFoundCode is the HTTP code returned for type PermitPackUserNotFound
const PermitPackUserNotFoundCode int = 404

/*PermitPackUserNotFound Pack or user not found

swagger:response permitPackUserNotFound
*/
...
// NewPermitPackUserNotFound creates PermitPackUserNotFound with default headers values
func NewPermitPackUserNotFound() *PermitPackUserNotFound {

	return &PermitPackUserNotFound{}
}

// WithPayload adds the payload to the permit pack user not found response
func (o *PermitPackUserNotFound) WithPayload(payload *models.GeneralError) *PermitPackUserNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the permit pack user not found response
func (o *PermitPackUserNotFound) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *PermitPackUserNotFound) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
...
/*PermitPackUserPreconditionFailed User is not assigned
...
/*PermitPackUserUnprocessableEntity Failed to validate request
...
func (o *PermitPackUserUnprocessableEntity) WithPayload(payload *models.ValidationError) *PermitPackUserUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the permit pack user unprocessable entity response
func (o *PermitPackUserUnprocessableEntity) SetPayload(payload *models.ValidationError) {
	o.Payload = payload
}
