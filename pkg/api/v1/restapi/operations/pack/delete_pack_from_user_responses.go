...
/*DeletePackFromUserPreconditionFailed Failed to parse request body
...
// DeletePackFromUserUnprocessableEntityCode is the HTTP code returned for type DeletePackFromUserUnprocessableEntity
const DeletePackFromUserUnprocessableEntityCode int = 422

/*DeletePackFromUserUnprocessableEntity User is not assigned

swagger:response deletePackFromUserUnprocessableEntity
*/
...
// NewDeletePackFromUserUnprocessableEntity creates DeletePackFromUserUnprocessableEntity with default headers values
...
// WithPayload adds the payload to the delete pack from user unprocessable entity response
func (o *DeletePackFromUserUnprocessableEntity) WithPayload(payload *models.GeneralError) *DeletePackFromUserUnprocessableEntity {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete pack from user unprocessable entity response
func (o *DeletePackFromUserUnprocessableEntity) SetPayload(payload *models.GeneralError) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *DeletePackFromUserUnprocessableEntity) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
