...
func (m *PackIcon) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *PackIcon) validateID(formats strfmt.Registry) error {
...
func (m *PackIcon) validatePack(formats strfmt.Registry) error {
...
func (m *PackIcon) validatePackID(formats strfmt.Registry) error {
...
func (m *PackIcon) validateUpdatedAt(formats strfmt.Registry) error {
...
func (m *PackIcon) contextValidateCreatedAt(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PackIcon) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PackIcon) contextValidatePack(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PackIcon) contextValidateUpdatedAt(ctx context.Context, formats strfmt.Registry) error {
