...
func (m *User) validateMods(formats strfmt.Registry) error {
...
func (m *User) validatePacks(formats strfmt.Registry) error {
...
func (m *User) contextValidateMods(ctx context.Context, formats strfmt.Registry) error {
...
func (m *User) contextValidatePacks(ctx context.Context, formats strfmt.Registry) error {
