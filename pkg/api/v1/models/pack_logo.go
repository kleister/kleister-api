...
func (m *PackLogo) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *PackLogo) validateID(formats strfmt.Registry) error {
...
func (m *PackLogo) validatePack(formats strfmt.Registry) error {
...
func (m *PackLogo) validatePackID(formats strfmt.Registry) error {
...
func (m *PackLogo) validateUpdatedAt(formats strfmt.Registry) error {
...
func (m *PackLogo) contextValidateCreatedAt(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PackLogo) contextValidateID(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PackLogo) contextValidatePack(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PackLogo) contextValidateUpdatedAt(ctx context.Context, formats strfmt.Registry) error {
