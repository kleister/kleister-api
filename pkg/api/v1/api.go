...
//go:generate gorunpkg github.com/go-swagger/go-swagger/cmd/swagger generate server --target . --name Kleister --spec ../../../openapi/v1.yml --exclude-main --regenerate-configureapi
