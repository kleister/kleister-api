...
func (m *MockService) Create(arg0 context.Context, arg1 *model.Mod) (*model.Mod, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) List(arg0 context.Context) ([]*model.Mod, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Update(arg0 context.Context, arg1 *model.Mod) (*model.Mod, error) {
	m.ctrl.T.Helper()
