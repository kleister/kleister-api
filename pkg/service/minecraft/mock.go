...
func (m *MockService) Search(arg0 context.Context, arg1 string) ([]*model.Minecraft, error) {
	m.ctrl.T.Helper()
...
// Search mocks base method.
func (m *MockStore) Search(arg0 context.Context, arg1 string) ([]*model.Minecraft, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Search", arg0, arg1)
	ret0, _ := ret[0].([]*model.Minecraft)
	ret1, _ := ret[1].(error)
...
// Show mocks base method.
func (m *MockStore) Show(arg0 context.Context, arg1 string) (*model.Minecraft, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Show", arg0, arg1)
	ret0, _ := ret[0].(*model.Minecraft)
	ret1, _ := ret[1].(error)
