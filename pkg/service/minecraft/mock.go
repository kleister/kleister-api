...
// Source: pkg/service/minecraft/service.go
...
import (
	...
	version "github.com/kleister/go-minecraft/version"
...
func (m *MockService) AttachBuild(arg0 context.Context, arg1 model.MinecraftBuildParams) error {
	m.ctrl.T.Helper()
...
func (m *MockService) DropBuild(arg0 context.Context, arg1 model.MinecraftBuildParams) error {
	m.ctrl.T.Helper()
...
func (m *MockService) List(arg0 context.Context, arg1 model.ListParams) ([]*model.Minecraft, int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) ListBuilds(arg0 context.Context, arg1 model.MinecraftBuildParams) ([]*model.Build, int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Show(arg0 context.Context, arg1 string) (*model.Minecraft, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Sync(arg0 context.Context, arg1 version.Versions) error {
	m.ctrl.T.Helper()
