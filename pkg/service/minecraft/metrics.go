...
func (s *metricsService) Search(ctx context.Context, search string) ([]*model.Minecraft, error) {
...
func (s *metricsService) Show(ctx context.Context, id string) (*model.Minecraft, error) {
	defer func(start time.Time) {
