...
func (s *metricsService) List(ctx context.Context, params model.UserModParams) ([]*model.UserMod, int64, error) {
...
func (s *metricsService) Attach(ctx context.Context, params model.UserModParams) error {
	defer func(start time.Time) {
...
func (s *metricsService) Permit(ctx context.Context, params model.UserModParams) error {
	defer func(start time.Time) {
...
func (s *metricsService) Drop(ctx context.Context, params model.UserModParams) error {
	defer func(start time.Time) {
