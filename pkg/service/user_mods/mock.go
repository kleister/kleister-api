...
// Source: pkg/service/user_mods/service.go
...
func (m *MockService) Attach(arg0 context.Context, arg1 model.UserModParams) error {
	m.ctrl.T.Helper()
...
func (m *MockService) Drop(arg0 context.Context, arg1 model.UserModParams) error {
	m.ctrl.T.Helper()
...
func (m *MockService) List(arg0 context.Context, arg1 model.UserModParams) ([]*model.UserMod, int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Permit(arg0 context.Context, arg1 model.UserModParams) error {
	m.ctrl.T.Helper()
