...
// Source: pkg/service/build_versions/service.go
...
func (m *MockService) Drop(arg0 context.Context, arg1 model.BuildVersionParams) error {
	m.ctrl.T.Helper()
...
func (m *MockService) List(arg0 context.Context, arg1 model.BuildVersionParams) ([]*model.BuildVersion, int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", arg0, arg1)
	ret0, _ := ret[0].([]*model.BuildVersion)
	ret1, _ := ret[1].(int64)
	ret2, _ := ret[2].(error)
