...
var file_types_v1_user_proto_rawDesc = []byte{
	...
	0x67, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x73, 0x6c, 0x75, 0x67, 0x12, 0x1a, 0x0a,
	...
	0x08, 0x6c, 0x61, 0x73, 0x74, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x64, 0x6d,
	...
	0x6d, 0x70, 0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x42, 0x99, 0x01,
	...
	0x67, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f,
...
var file_types_v1_user_proto_goTypes = []interface{}{
...
var file_types_v1_user_proto_depIdxs = []int32{
	...
	1, // 1: types.v1.User.updated_at:type_name -> google.protobuf.Timestamp
...
func file_types_v1_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_types_v1_user_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
