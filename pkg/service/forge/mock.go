...
func (m *MockService) AttachBuild(arg0 context.Context, arg1 model.ForgeBuildParams) error {
	m.ctrl.T.Helper()
...
func (m *MockService) DropBuild(arg0 context.Context, arg1 model.ForgeBuildParams) error {
	m.ctrl.T.Helper()
...
func (m *MockService) List(arg0 context.Context, arg1 model.ListParams) ([]*model.Forge, int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) ListBuilds(arg0 context.Context, arg1 model.ForgeBuildParams) ([]*model.Build, int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Show(arg0 context.Context, arg1 string) (*model.Forge, error) {
	m.ctrl.T.Helper()
