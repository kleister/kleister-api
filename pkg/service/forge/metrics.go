		...
		requestLatency: m.RegisterHistogram(
			prometheus.NewHistogramVec(
				prometheus.HistogramOpts{
					...
					Subsystem: "forge_service",
					Name:      "request_latency_microseconds",
					Help:      "Histogram of latencies for requests to the forge service.",
		...
		errorsCount: m.RegisterCounter(
			prometheus.NewCounterVec(
				prometheus.CounterOpts{
					...
					Subsystem: "forge_service",
					Name:      "errors_count",
					Help:      "Total number of errors within the forge service.",
				},
				[]string{"method"},
			),
		),
		requestCount: m.RegisterCounter(
			prometheus.NewCounterVec(
				prometheus.CounterOpts{
					...
					Subsystem: "forge_service",
					Name:      "request_count",
					Help:      "Total number of requests to the forge service.",
				},
				[]string{"method"},
			),
		),
...
func (s *metricsService) List(ctx context.Context, params model.ListParams) ([]*model.Forge, int64, error) {
...
func (s *metricsService) Show(ctx context.Context, name string) (*model.Forge, error) {
	defer func(start time.Time) {
...
func (s *metricsService) ListBuilds(ctx context.Context, params model.ForgeBuildParams) ([]*model.Build, int64, error) {
	defer func(start time.Time) {
...
func (s *metricsService) AttachBuild(ctx context.Context, params model.ForgeBuildParams) error {
	defer func(start time.Time) {
...
func (s *metricsService) DropBuild(ctx context.Context, params model.ForgeBuildParams) error {
	defer func(start time.Time) {
