...
func (s *metricsService) Search(ctx context.Context, search string) ([]*model.Forge, error) {
...
func (s *metricsService) Show(ctx context.Context, id string) (*model.Forge, error) {
	defer func(start time.Time) {
