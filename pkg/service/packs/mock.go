...
// Source: pkg/service/packs/service.go
...
func (m *MockService) Create(arg0 context.Context, arg1 *model.Pack) error {
	m.ctrl.T.Helper()
...
func (m *MockService) List(arg0 context.Context, arg1 model.ListParams) ([]*model.Pack, int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Show(arg0 context.Context, arg1 string) (*model.Pack, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Update(arg0 context.Context, arg1 *model.Pack) error {
	m.ctrl.T.Helper()
