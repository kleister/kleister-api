...
// Source: pkg/service/team_packs/service.go
...
func (m *MockService) Attach(arg0 context.Context, arg1 model.TeamPackParams) error {
	m.ctrl.T.Helper()
...
func (m *MockService) Drop(arg0 context.Context, arg1 model.TeamPackParams) error {
	m.ctrl.T.Helper()
...
func (m *MockService) List(arg0 context.Context, arg1 model.TeamPackParams) ([]*model.TeamPack, int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Permit(arg0 context.Context, arg1 model.TeamPackParams) error {
	m.ctrl.T.Helper()
