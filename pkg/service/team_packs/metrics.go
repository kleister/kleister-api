...
func (s *metricsService) List(ctx context.Context, teamID, packID string) ([]*model.TeamPack, error) {
...
func (s *metricsService) Attach(ctx context.Context, teamID, packID, perm string) error {
	defer func(start time.Time) {
...
func (s *metricsService) Permit(ctx context.Context, teamID, packID, perm string) error {
	defer func(start time.Time) {
...
func (s *metricsService) Drop(ctx context.Context, teamID, packID string) error {
	defer func(start time.Time) {
