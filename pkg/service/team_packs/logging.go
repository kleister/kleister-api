...
func (s *loggingService) List(ctx context.Context, params model.TeamPackParams) ([]*model.TeamPack, int64, error) {
	start := time.Now()
...
func (s *loggingService) Attach(ctx context.Context, params model.TeamPackParams) error {
	start := time.Now()
...
func (s *loggingService) Permit(ctx context.Context, params model.TeamPackParams) error {
	start := time.Now()
...
func (s *loggingService) Drop(ctx context.Context, params model.TeamPackParams) error {
	start := time.Now()
