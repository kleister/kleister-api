...
// Source: pkg/service/neoforge/service.go
...
import (
	...
	neoforge "github.com/kleister/kleister-api/pkg/internal/neoforge"
...
func (m *MockService) Search(arg0 context.Context, arg1 string) ([]*model.Neoforge, error) {
	m.ctrl.T.Helper()
...
// Search mocks base method.
func (m *MockStore) Search(arg0 context.Context, arg1 string) ([]*model.Neoforge, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Search", arg0, arg1)
	ret0, _ := ret[0].([]*model.Neoforge)
	ret1, _ := ret[1].(error)
...
func (m *MockStore) Sync(arg0 context.Context, arg1 neoforge.Versions) error {
	m.ctrl.T.Helper()
