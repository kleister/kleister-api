...
func (s *metricsService) Search(ctx context.Context, search string) ([]*model.Neoforge, error) {
...
func (s *metricsService) Show(ctx context.Context, id string) (*model.Neoforge, error) {
	defer func(start time.Time) {
