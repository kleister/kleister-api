		...
		requestLatency: m.RegisterHistogram(
			prometheus.NewHistogramVec(
				prometheus.HistogramOpts{
					...
					Subsystem: "neoforge_service",
					Name:      "request_latency_microseconds",
					Help:      "Histogram of latencies for requests to the neoforge service.",
		...
		errorsCount: m.RegisterCounter(
			prometheus.NewCounterVec(
				prometheus.CounterOpts{
					...
					Subsystem: "neoforge_service",
					Name:      "errors_count",
					Help:      "Total number of errors within the neoforge service.",
				},
				[]string{"method"},
			),
		),
		requestCount: m.RegisterCounter(
			prometheus.NewCounterVec(
				prometheus.CounterOpts{
					...
					Subsystem: "neoforge_service",
					Name:      "request_count",
					Help:      "Total number of requests to the neoforge service.",
				},
				[]string{"method"},
			),
		),
...
func (s *metricsService) List(ctx context.Context, params model.ListParams) ([]*model.Neoforge, int64, error) {
...
func (s *metricsService) Show(ctx context.Context, name string) (*model.Neoforge, error) {
	defer func(start time.Time) {
...
func (s *metricsService) Sync(ctx context.Context, versions neoforgeClient.Versions) error {
	defer func(start time.Time) {
...
func (s *metricsService) ListBuilds(ctx context.Context, params model.NeoforgeBuildParams) ([]*model.Build, int64, error) {
	defer func(start time.Time) {
...
func (s *metricsService) AttachBuild(ctx context.Context, params model.NeoforgeBuildParams) error {
	defer func(start time.Time) {
...
func (s *metricsService) DropBuild(ctx context.Context, params model.NeoforgeBuildParams) error {
	defer func(start time.Time) {
