		...
		requestLatency: m.RegisterHistogram(
			prometheus.NewHistogramVec(
				prometheus.HistogramOpts{
					...
					Subsystem: "quilt_service",
					Name:      "request_latency_microseconds",
					Help:      "Histogram of latencies for requests to the quilt service.",
		...
		errorsCount: m.RegisterCounter(
			prometheus.NewCounterVec(
				prometheus.CounterOpts{
					...
					Subsystem: "quilt_service",
					Name:      "errors_count",
					Help:      "Total number of errors within the quilt service.",
				},
				[]string{"method"},
			),
		),
		requestCount: m.RegisterCounter(
			prometheus.NewCounterVec(
				prometheus.CounterOpts{
					...
					Subsystem: "quilt_service",
					Name:      "request_count",
					Help:      "Total number of requests to the quilt service.",
				},
				[]string{"method"},
			),
		),
...
func (s *metricsService) List(ctx context.Context, params model.ListParams) ([]*model.Quilt, int64, error) {
...
func (s *metricsService) Show(ctx context.Context, name string) (*model.Quilt, error) {
	defer func(start time.Time) {
...
func (s *metricsService) Sync(ctx context.Context, versions quiltClient.Versions) error {
	defer func(start time.Time) {
...
func (s *metricsService) ListBuilds(ctx context.Context, params model.QuiltBuildParams) ([]*model.Build, int64, error) {
	defer func(start time.Time) {
...
func (s *metricsService) AttachBuild(ctx context.Context, params model.QuiltBuildParams) error {
	defer func(start time.Time) {
...
func (s *metricsService) DropBuild(ctx context.Context, params model.QuiltBuildParams) error {
	defer func(start time.Time) {
