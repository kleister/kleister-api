...
func (s *metricsService) Search(ctx context.Context, search string) ([]*model.Quilt, error) {
...
func (s *metricsService) Show(ctx context.Context, id string) (*model.Quilt, error) {
	defer func(start time.Time) {
