...
func (s *GormService) List(ctx context.Context, params model.ListParams) ([]*model.Quilt, int64, error) {
...
func (s *GormService) ListBuilds(ctx context.Context, params model.QuiltBuildParams) ([]*model.Build, int64, error) {
	parent, err := s.Show(ctx, params.QuiltID)
...
func (s *GormService) AttachBuild(ctx context.Context, params model.QuiltBuildParams) error {
	parent, err := s.Show(ctx, params.QuiltID)
...
func (s *GormService) DropBuild(ctx context.Context, params model.QuiltBuildParams) error {
	parent, err := s.Show(ctx, params.QuiltID)
...
func (s *GormService) buildID(ctx context.Context, packID, id string) (string, string, error) {
	...
	return result.ID, result.QuiltID, nil
}
