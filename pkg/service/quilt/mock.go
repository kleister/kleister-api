...
func (m *MockService) AttachBuild(arg0 context.Context, arg1 model.QuiltBuildParams) error {
	m.ctrl.T.Helper()
...
func (m *MockService) DropBuild(arg0 context.Context, arg1 model.QuiltBuildParams) error {
	m.ctrl.T.Helper()
...
func (m *MockService) List(arg0 context.Context, arg1 model.ListParams) ([]*model.Quilt, int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) ListBuilds(arg0 context.Context, arg1 model.QuiltBuildParams) ([]*model.Build, int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Show(arg0 context.Context, arg1 string) (*model.Quilt, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Sync(arg0 context.Context, arg1 quilt.Versions) error {
	m.ctrl.T.Helper()
