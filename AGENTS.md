...
**Kleister API** is a backend and embedded Vue frontend for managing Minecraft
mod packs and related metadata such as users, groups, mods, packs, versions,
and game loader/build information.
